...
class DataHandlerGeneralCF:
    ...
    def _make_torch_adj2(self, mat):
        ...
        sparse_tensor = t.sparse_coo_tensor(indices, values, mat.shape).coalesce()

        return sparse_tensor.to(configs['device'])
    ...
    def _make_torch_adj(self, mat, self_loop=False):
        ...
        return t.sparse.FloatTensor(idxs, vals, shape).coalesce().to(configs['device'])
